...
public class User {
	...
	@ValidEmail(min = 6, message = "This email is not correct.")
	...
	public User(int id, String first_name, String last_name, String email, String password, String dateofbirth,
			String gender, String city, String country, int posts, int followers, int followings, int deleted,
			String login_time, String logout_time, int count_login, String created, String updated, String role_name,
			String value_search, Blob avatar) {
		super();
		this.id = id;
