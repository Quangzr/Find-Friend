...
<spring:url value="/searchSex" var="searchForm" />
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div id="page-contents" class="page-contents">
		<div class="container">
          ...
          ================================================= -->
				...
				<div class="col-md-9">
					<h2 style="text-align: center"> Find People Sex
					</h2>
					<form name="searchForm" id='searchForm' modelAttribute="searchForm"
						...
						<div class="row" style="margin-bottom: 30px">
							<div class="col-md-11">
								<input type="text" class="form-control" placeholder="Search friend (Girl/Boy/other)" name="gender"">
							</div>
							<div class="col-md-1">
