...
<script async defer
	...
	<script src="js/js/uploadImage.js"></script>
	<script src="js/js/uploadAvatar.js"></script>
...
<script>
	...
	function changeText(id) {
		...
		$.ajax({
		type: "GET",
		url: '${pageContext.request.contextPath}/sendMessage/' + id,
		dataType: "json",
		crossDomain: true,
				...
				<div class="col-md-4">
					<div id="chat-block">
						...
						<ul class="online-users list-inline">
							<li>
								<c:forEach var="m" items="${userChat}">
										<div class="follow-user follow-${m.id}">
											...
											<div>
												...
												<a href="${pageContext.request.contextPath}/chat/${m.id}" class="change-text text-green">Chat</a>
											</div>
										</div>
									</c:forEach>
							</li>
