...
<spring:url value="/searchAddress" var="searchForm" />
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div id="page-contents" class="page-contents">
		<div class="container">
          ...
          ================================================= -->
				...
				<div class="col-md-9">
					<h2 style="text-align: center"> Find People Nearly
					</h2>
					<form name="searchForm" id='searchForm' modelAttribute="searchForm"
									action="${searchForm }" method="post" onsubmit="return validateform()">
						<div class="row" style="margin-bottom: 30px">
							<div class="col-md-11">
								<input type="text" class="form-control" placeholder="Search friend" name="city"">
							</div>
							<div class="col-md-1">
							...
							<c:when test="${ not empty listUserSearchFollowing }">
								<c:forEach var="bid" items="${listUserSearchFollowing}" varStatus="item" >
									<tr>
										...
										<%-- <td>
											<input id="btn-active" type="button" class="btn btn-danger" value="Unfollow" onclick="doUnfollow()" />
											<input type="hidden" id="id" onclick="doUnfollow();" value="${bid.id }" />
										</td> --%>
									</tr>
								</c:forEach>
							</c:when>
